...
require (
	...
	buf.build/gen/go/git-age/agent/protocolbuffers/go v1.34.2-20240316114246-f87464bfe857.1
	buf.build/gen/go/grpc/grpc/connectrpc/go v1.16.2-20240617172854-9d87e32e5325.1
